...
#   endorsar o promover productos derivados sin
#   permiso previo por escrito.
#
# ESTE SOFTWARE SE PROPORCIONA "TAL CUAL" SIN GARANTÍAS DE NINGÚN TIPO.
# EN NINGÚN CASO LOS AUTORES SERÁN RESPONSABLES POR DAÑOS DE NINGÚN TIPO.
# -----------------------------------------------------------------------------
#
# Implementa un parser LR construido a partir de reglas gramaticales definidas
# como funciones Python. La gramática se especifica mediante BNF en docstrings.
# Inspirado en el sistema Spark de John Aycock. PLY es una combinación entre
# Spark y la utilidad GNU bison.
#
# La implementación actual es parcialmente orientada a objetos. El parser LR
# está definido como objeto (lo que permite múltiples parsers simultáneos),
# pero la mayoría de variables de construcción de tablas son globales.
#
# Soporta parsing SLR y LALR(1). El soporte LALR(1) fue implementado
# originalmente por Elias Ioup usando el algoritmo del Libro del Dragón.
# Actualmente se usa el algoritmo más eficiente de DeRemer y Pennello.
#
# :::::::: ADVERTENCIA :::::::
#
# La construcción de las tablas de parsing LR es costosa y compleja.
# Para que este módulo sea rápido, se ha sacrificado legibilidad.
# Modifica el código bajo tu propio riesgo.
# own risk!
# ----------------------------------------------------------------------------
...
class LRParser:
    ...
    def parse(self, input=None, lexer=None, debug=False, tracking=False):
        ...
        lookahead = None                         # Símbolo de anticipación actual
...
class Grammar(object):
    ...
    # reglas gramaticales.  Returns a list of tuples (sym, prod) where sym in the symbol
                            ...
                            for a in laheads:
                                ...
                                if r is not None:
                                    ...
                                    if r > 0:
                                        ...
                                        # Desplazar precedence comes from the token
                                        sprec, slevel = Precedence.get(a, ('right', 0))

                                        # Reducir precedence comes from rule being reduced (p)
                                        ...
                                        # Conflicto reducción/reducción.   In this case, we favor the rule
                            ...
                            if j >= 0:
                                ...
                                if r is not None:
                                    ...
                                    if r > 0:
                                        ...
                                        # Reducir precedence comes from the rule that could have been reduced
...
def yacc(*, debug=yaccdebug, module=None, start=None,
    ...
    # Obtener el diccionario del módulo used for the parser
    if module:
