...
# Si ocurre un error en tiempo de ejecución, entrar al modo interactivo.
if len(sys.argv) == 2:
...
# Modo interactivo. Agrega/elimina sentencias del BasicInterpreter.
# Comandos especiales: 'NEW', 'LIST' y 'RUN'.
